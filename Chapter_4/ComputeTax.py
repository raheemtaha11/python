...
status = input("0-single filer, 1-married jointly," + "2-married separately, 3-head of household" + 
"Enter the filling status:")

# Prompt the user to enter taxable income
income = input("Enter the taxable income:")
...
if status == 0: # Compute tax for single filers
    if income <= 8350:
        ...
        tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (82250 - 33950) * 0.25 + (171550 - 88250) * 0.28 + (income - 171550) * 0.33
